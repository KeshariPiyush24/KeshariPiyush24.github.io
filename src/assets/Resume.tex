...
\begin{multicols}{2}
    \begin{itemize}[itemsep=0.5pt, parsep=0.5pt, leftmargin=65pt]
        ...
        \item[\textbf{Frontend}] React.js, Next.js, Redux, HTML5, CSS3, Tailwind, Material UI, SAAS, Pug.js
        \item[\textbf{Backend}] Node.js, Express.js, REST APIs
        \item[\textbf{Databases}] MongoDB, MySQL, Redis, DynamoDB, Neo4j
        \item[\textbf{Testing}] Mocha, Chai.js, TDD, Unit Testing
        \item[\textbf{DevOps}] Docker, AWS, Git, GitHub,
        Linux, Cloudflare
        \item[\textbf{Tools}] VS-Code, Postman, Sentry, JIRA, Chrome DevTools, Figma, Kibana
